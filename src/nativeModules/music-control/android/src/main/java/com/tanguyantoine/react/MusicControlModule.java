...
public class MusicControlModule extends ReactContextBaseJavaModule {
    ...
    public void setNowPlaying(ReadableMap metadata) {
        ...
        if(artwork != null && !artwork.isEmpty()) {
            ...
            ReactApplicationContext context = getReactApplicationContext();
            Bitmap defaultImg = BitmapFactory
                .decodeResource(context.getResources(), R.drawable.track);
            md.putBitmap(MediaMetadataCompat.METADATA_KEY_ART, defaultImg);
            nb.setLargeIcon(defaultImg);
        }
